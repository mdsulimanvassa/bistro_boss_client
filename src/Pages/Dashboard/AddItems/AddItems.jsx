...
const AddItems = () => {
    ...
    const onSubmit = async (data) => {
        ...
        if(res.data.success){
            ...
            const result = await axiosSecoure.post('/menu', menuItem);
    ...
    return (
        <div>
            <SectionTitle hading={'ADD AN ITEM'} subHading={"what's new?"}></SectionTitle>
            <div className="admin_form">
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="">
                        ...
                        <input type="text" name='name' {...register("name", { required: true })} placeholder="Recipe name" className="input input-bordered" />
                    ...
                    <div className="">
                        <label className="form-control">
                            ...
                            <textarea name='recipe' className="textarea textarea-bordered h-24 w-50" {...register("recipe", { required: true })}placeholder="Recipe Details" ></textarea>
                    ...
                    <button className="btn_successfully">Add Item <FaUtensils className='admin_icon' /></button>
                </form>
            </div>
        </div>
    );
